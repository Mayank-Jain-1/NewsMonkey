...
export default class Home extends Component {
  ...
  render() {
    return (
      ...
      <News setProgress = {this.props.setProgress} key={this.state.key} newsGenre = {this.state.newsGenre} pageSize= {this.state.pageSize} newsCountry={this.state.newsCountry} />
      </>
    )
  }
}
